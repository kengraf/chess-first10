    ...
    "widgets": [
      ...
      },
      {
        ...
        "properties": {
          ...
          "metrics": [
            ...
            ["AWS/Lambda", "Errors",   "FunctionName", "chess-first10-DatabaseItems", {"stat": "Sum", "color": "#ff9900"}],
      ...
      },
      {
        ...
        "properties": {
          "title": "Alarm status",
          "alarms": [
            "arn:aws:cloudwatch:us-east-2:788715698479:alarm:first10-apigw-5xx-count",
            "arn:aws:cloudwatch:us-east-2:788715698479:alarm:first10-apigw-5xx-rate",
            "arn:aws:cloudwatch:us-east-2:788715698479:alarm:first10-verifyToken-errors",
            "arn:aws:cloudwatch:us-east-2:788715698479:alarm:first10-dynamodb-system-errors",
            "arn:aws:cloudwatch:us-east-2:788715698479:alarm:first10-lambda-throttles",
            "arn:aws:cloudwatch:us-east-2:788715698479:alarm:first10-log-ingest"
          ]
        }
      }
    ]
